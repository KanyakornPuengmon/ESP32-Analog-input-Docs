...
เมื่อ Volume หากคุณหมุน Volume ไปขวาสุด ค่า channel-o raw read result ควรจะลดลงจนใกล้ 0 และถ้าหมุนไปซ้ายสุด ค่า channel-o raw read result มีค่า 4095 (หันหน้าเข้าหาที่หมุน volume)
